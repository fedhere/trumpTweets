...
So as I set off to find patterns in Trump's tweets I found that they are really boring and average, from a data science perspective. Nonetheless, I am gonna keep running this analysis, updating it weekly. hoping to spot signs of his popularity decreaseing. everyweek the new notebooks and figure folders will be labelled by the date when they were run. The entire original work is in the notebook <a href="https://github.com/fedhere/trumpTweets/blob/master/tweetsAnalysis.ipynb"> tweetsAnalysis.ipynb</a>. 

Here are some of the week patterns I found in this first analysis. If you are not used to read notebooks, you can look at the figures, figure comments, and text cells, skipping the code, to get the story. There are a lot more comments and plots than those which I summarize below.
...
<a href="https://github.com/fedhere/trumpTweets/blob/master/tweetsAnalysis_update.ipynb">**Update**</a> As or March 20 the likes/retweets rate has decreased steadily since inauguration, but dont get too exciter: it is still just above what it was at election night.
<a href="https://github.com/fedhere/trumpTweets/blob/master/tweetsAnalysis_update.ipynb"><img src="https://github.com/fedhere/trumpTweets/blob/master/figs_2017-03-19/fig1b.jpg"  width="423" ><img src="https://github.com/fedhere/trumpTweets/blob/master/figs_2017-03-19/fig2.jpg"  width="423" ></a>
